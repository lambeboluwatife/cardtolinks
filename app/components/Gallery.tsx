...
import { galleryData } from "../data/generate";
...
export default function Gallery() {
  ...
  return (
    <div className="px-6 w-full my-10">
      <div className="flex items-center justify-between w-full mb-2">
        <h1 className="font-semibold">Gallery</h1>

        <div className="flex items-center space-x-2">
          <div className="flex items-center gap-1 text-[12px] font-medium bg-gray-100  text-black px-3 py-1 rounded-xl cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-600 transition">
            <IoDocuments size={15} />
            Legal
          </div>
          <div className="flex items-center gap-1 text-[12px] font-medium bg-gray-100  text-black px-3 py-1 rounded-xl cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-600 transition">
      ...
      <div className="my-2 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        {galleryData.map((item) => (
          <div
            key={item.id}
            className="relative rounded-xl overflow-hidden bg-[--color-secondary] border border-transparent hover:shadow-lg transition cursor-pointer"
      ...
      {selected && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-[--color-background] p-4"
